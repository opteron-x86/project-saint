...
>>>>>>> e62eca1 (error fixes for rulefilterbar)
=======
import React, { useState, useCallback, useMemo, useEffect } from 'react';
...
>>>>>>> a380730 (Initial deployment)
=======
  TextField, // Retained for SearchBar structure, though SearchBar itself is simplified
>>>>>>> 984e985 (backend rework for rule_platforms)
=======
  // TextField, // No longer needed here
>>>>>>> 81c958a (search feature)
=======
  Popover,
>>>>>>> 5082346 (search feature)
  Tooltip,
  Typography,
  Checkbox,
  useTheme,
...
import FilterListIcon from '@mui/icons-material/FilterList';
import CloseIcon from '@mui/icons-material/Close';
// import SearchIcon from '@mui/icons-material/Search'; // SearchBar handles its own icon
=======
>>>>>>> 81c958a (search feature)
import ClearIcon from '@mui/icons-material/Clear';
import TuneIcon from '@mui/icons-material/Tune';
...
<<<<<<< HEAD
        <Box sx={{ p: 2, mt: 'auto', borderTop: `1px solid ${theme.palette.divider}`, display: 'flex', justifyContent: 'space-between' }}>
            <Button variant="outlined" color="error" onClick={() => { clearFilters(); setFilterDrawerOpen(false);}} startIcon={<ClearIcon />}>
              Clear All
            </Button>
            <Button variant="contained" color="primary" onClick={() => setFilterDrawerOpen(false)}>
              Apply
            </Button>
        </Box>
>>>>>>> a380730 (Initial deployment)
