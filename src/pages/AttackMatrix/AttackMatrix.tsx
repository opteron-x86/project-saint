...
>>>>>>> ab16e70 (refactoring attack matrix)
=======
import React, { useState, useCallback, useMemo, useEffect, lazy, Suspense } from 'react';
...
<<<<<<< HEAD
=======
  // Imports for Platform Filter
>>>>>>> ab16e70 (refactoring attack matrix)
=======
>>>>>>> 503c8e2 (refactoring attack matrix)
  Popover,
  FormGroup,
  FormControlLabel,
  Checkbox,
...
>>>>>>> a380730 (Initial deployment)
=======
// FullscreenIcon was unused
>>>>>>> 503c8e2 (refactoring attack matrix)
=======
>>>>>>> 1abc8fb (refactoring attack matrix)
...
>>>>>>> ab16e70 (refactoring attack matrix)
import { SearchBar, StatusBadge, EmptyState, LoadingIndicator, ErrorDisplay } from '../../components/common';
import { RuleDetail } from '../../components/rules'; // Reusing the main RuleDetail component
=======
import { SearchBar, StatusBadge, EmptyState, LoadingIndicator, ErrorDisplay } from '@/components/common';
<<<<<<< HEAD
import { RuleDetail } from '@/components/rules'; // Reusing the main RuleDetail component
...
<<<<<<< HEAD
<<<<<<< HEAD
// Define fixed cell dimensions for the matrix
>>>>>>> a380730 (Initial deployment)
=======
// Define fixed cell dimensions for the matrix (consider moving to a constants file if reused)
>>>>>>> ab16e70 (refactoring attack matrix)
=======
// Define fixed cell dimensions for the matrix
>>>>>>> 503c8e2 (refactoring attack matrix)
...
// --- Prop Interfaces for Cell Components ---
=======
>>>>>>> 1abc8fb (refactoring attack matrix)
...
=======
// TechniqueCell component
=======
// --- TechniqueCell, SubtechniqueCell, TacticHeader Components ---
// These are good candidates for moving to separate files in src/components/matrix/
// For brevity, I'll assume they are defined as in your provided code.
// TechniqueCell (React.memo)
>>>>>>> ab16e70 (refactoring attack matrix)
const TechniqueCell = React.memo(({
=======
}
...
const TechniqueCell: React.FC<TechniqueCellProps> = React.memo(({
>>>>>>> 503c8e2 (refactoring attack matrix)
  technique,
  tactic,
  expanded,
...
<<<<<<< HEAD
<<<<<<< HEAD
  const coverage = coverageData?.techniques?.[technique.technique_id];
  const coverageCount = coverage?.count || 0;
>>>>>>> a380730 (Initial deployment)
=======
  const coverageCount = coverageData?.techniques?.[technique.technique_id]?.count || 0; // Adjusted to find by technique_id
>>>>>>> ab16e70 (refactoring attack matrix)
=======
=======
=======
...
>>>>>>> bae12e2 (Feature/dashboard improvements)
  const hasSubtechniques = technique.subtechniques && technique.subtechniques.length > 0 && technique.subtechniques.some(st => !st.is_deprecated);
>>>>>>> a04762f (Sub-technique Filter & Error Fixes)
  const techniqueCoverage = coverageData?.techniques.find(tc => tc.technique_id === technique.id);
  const coverageCount = techniqueCoverage?.count || 0;
>>>>>>> 503c8e2 (refactoring attack matrix)
...
<<<<<<< HEAD
              <IconButton 
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  onExpand(technique.technique_id);
                }}
                sx={{ 
                  p: 0, 
                  ml: 0.5, 
...
const SubtechniqueCell: React.FC<SubtechniqueCellProps> = React.memo(({
  subtechnique,
  tactic,
  coverageData,
  onSelect,
...
<<<<<<< HEAD
<<<<<<< HEAD
  const coverage = coverageData?.techniques?.[subtechnique.technique_id];
  const coverageCount = coverage?.count || 0;
>>>>>>> a380730 (Initial deployment)
=======
  const coverageCount = coverageData?.techniques?.[subtechnique.technique_id]?.count || 0; // Adjusted
>>>>>>> ab16e70 (refactoring attack matrix)
=======
=======
>>>>>>> bae12e2 (Feature/dashboard improvements)
...
=======
        ...
        width: `calc(100% - ${SUBTECHNIQUE_INDENT}px)`,
        display: 'flex',
        flexDirection: 'column',
        justifyContent: 'space-between',
        alignItems: 'center',
        padding: 1,
        ml: `${SUBTECHNIQUE_INDENT}px`,
        bgcolor: cellColor,
        color: textColor,
        border: `1px solid ${theme.palette.divider}`,
        borderRadius: 1,
...
const TacticHeader: React.FC<TacticHeaderProps> = React.memo(({ tactic, onSelect, theme }) => {
=======
const TacticHeader: React.FC<{
  tactic: MitreTactic;
  onSelect: (tacticId: string) => void;
